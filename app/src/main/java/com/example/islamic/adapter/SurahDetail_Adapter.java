...
public class SurahDetail_Adapter extends RecyclerView.Adapter<SurahDetail_Adapter.viewHolder> {
    ...
    @NonNull
    @Override
    public SurahDetail_Adapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.surah_detail,null,false);
        return new SurahDetail_Adapter.viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SurahDetail_Adapter.viewHolder holder, int position) {
