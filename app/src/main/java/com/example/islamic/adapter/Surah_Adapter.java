...
public class Surah_Adapter extends RecyclerView.Adapter<Surah_Adapter.viewHolder> {
    ...
    @NonNull
    @Override
    public Surah_Adapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.surah,null,false);
        return new viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Surah_Adapter.viewHolder holder, int position) {
